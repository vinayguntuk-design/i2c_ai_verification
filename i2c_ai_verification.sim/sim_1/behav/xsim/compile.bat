...
REM
REM Generated by Vivado on Tue May 12 23:57:13 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj i2c_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj i2c_tb_vlog.prj -log xvlog.log
